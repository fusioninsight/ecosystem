...
![](assets/Using_Kylin1.6.0_with_FusionInsight_HD_C60U20/0a886.png)
...
* 安装编译工具
  ...
  ![](assets/Using_Kylin1.6.0_with_FusionInsight_HD_C60U20/image1.png)
...
* 安装nodejs：
  ...
  ![](assets/Using_Kylin1.6.0_with_FusionInsight_HD_C60U20/image2.png)
...
* 编译打包
  ...
  ![](assets/Using_Kylin1.6.0_with_FusionInsight_HD_C60U20/image3.png)

  等待编译完成，得到Kylin二进制安装包

  ![](assets/Using_Kylin1.6.0_with_FusionInsight_HD_C60U20/image4.png)
...
* 进行kerberos认证
  ...
  ![](assets/Using_Kylin1.6.0_with_FusionInsight_HD_C60U20/image5.png)
...
* Kylin检查环境设置：
  ...
  ![](assets/Using_Kylin1.6.0_with_FusionInsight_HD_C60U20/image6.png)
...
* 去掉不允许修改的配置
  ...
  ![](assets/Using_Kylin1.6.0_with_FusionInsight_HD_C60U20/image7.png)
...
* Hive lib路径
  ...
  ![](assets/Using_Kylin1.6.0_with_FusionInsight_HD_C60U20/image8.png)

### 启动Kylin

* 使用`./kylin.sh start`启动Kylin

  ![](assets/Using_Kylin1.6.0_with_FusionInsight_HD_C60U20/image9.png)

  ![](assets/Using_Kylin1.6.0_with_FusionInsight_HD_C60U20/image10.png)

  输入默认用户名密码：ADMIN/KYLIN登陆

  ![](assets/Using_Kylin1.6.0_with_FusionInsight_HD_C60U20/image11.png)
...
* 执行以下命令导入sample数据
  ...
  ![](assets/Using_Kylin1.6.0_with_FusionInsight_HD_C60U20/image12.png)

### 构建Cube

* 选择learn_kylin工程，构建默认的kylin_sales_cube

  ![](assets/Using_Kylin1.6.0_with_FusionInsight_HD_C60U20/image13.png)

* Cube构建成功，状态变为READY

  ![](assets/Using_Kylin1.6.0_with_FusionInsight_HD_C60U20/image14.png)

### 查询表数据

* 在Insight页面执行查询

  ![](assets/Using_Kylin1.6.0_with_FusionInsight_HD_C60U20/image15.png)

  ![](assets/Using_Kylin1.6.0_with_FusionInsight_HD_C60U20/image16.png)
