...
- Sart TOS_BD by clicking `TOS_BD-win-x86_64.exe`
  ...
  ![](assets/Talend/markdown-img-paste-20181027103716507.png)

  Installing additional Talend Packages

  ![](assets/Talend/markdown-img-paste-20181027103930508.png)

  ![](assets/Talend/markdown-img-paste-20181027104029626.png)
...
### HDFS Connection Procedure
  ...
  ![](assets/Talend/markdown-img-paste-20181027111926482.png)
  ...
  ![](assets/Talend/markdown-img-paste-20181027112247960.png)
...
### HDFS Get Procedure  
  ...
  ![](assets/Talend/markdown-img-paste-20181027112848678.png)
  ...
  ![](assets/Talend/markdown-img-paste-20181027113549569.png)


  Check the test outcome by coming into the local directory `C:/SOFT`

  ![](assets/Talend/markdown-img-paste-20181027113744223.png)
...
### HDFS Put Procedure
  ...
  ![](assets/Talend/markdown-img-paste-20181027114148747.png)
  ...
  ![](assets/Talend/markdown-img-paste-2018102711460775.png)
...
### Hive Connection Procedure
  ...
  ![](assets/Talend/markdown-img-paste-20181027141810509.png)
  ...
  ![](assets/Talend/markdown-img-paste-20181027142536795.png)
  ...
  ![](assets/Talend/markdown-img-paste-20181027143157715.png)



  - Test Completed：

  ![](assets/Talend/markdown-img-paste-20181027143538549.png)
...
### Hive Create Table & Load Procedure
  ...
  ![](assets/Talend/markdown-img-paste-20181027144138537.png)


  Note: It is required to **Edit schema** of the table

  ![](assets/Talend/markdown-img-paste-2018102714423808.png)


  - The configuration of **tHiveLoad** component shown as follows


  ![](assets/Talend/markdown-img-paste-20181027144612401.png)
  ...
  ![](assets/Talend/markdown-img-paste-20181027144750903.png)

  - Test Completed：

  ![](assets/Talend/markdown-img-paste-20181027144955115.png)
...
### Hive Input Procedure
  ...
  ![](assets/Talend/markdown-img-paste-20181027145453118.png)
  ...
  ![](assets/Talend/markdown-img-paste-20181027145630808.png)
  ...
  ![](assets/Talend/markdown-img-paste-20181027145824481.png)

  - Test Completed：

  ![](assets/Talend/markdown-img-paste-20181027150004526.png)

### Hive Row Procedure

  - The whole process is shown as the following pic:

  ![](assets/Talend/markdown-img-paste-2018091021431317.png)
  ...
  ![](assets/Talend/markdown-img-paste-20181027150354934.png)


  Note: It is required to **Edit schema** of hive table

  ![](assets/Talend/markdown-img-paste-20181027150458443.png)


  - Test Completed：

  ![](assets/Talend/markdown-img-paste-20181027150645583.png)


  Check the cluster outcome by login into the FusionInsight Cluster

  ![](assets/Talend/markdown-img-paste-20181027150815520.png)
...
### HBase Connection Procedure
  ...
  ![](assets/Talend/markdown-img-paste-2018091019371235.png)

  ![](assets/Talend/markdown-img-paste-20180910193823624.png)

  ![](assets/Talend/markdown-img-paste-20180910194042337.png)
  ...
  ![](assets/Talend/markdown-img-paste-20181027155307109.png)

  ![](assets/Talend/markdown-img-paste-20181027155451471.png)
  ...
  ![](assets/Talend/markdown-img-paste-20181027160217311.png)

### HBase Input Output Procedure
  - The content of the Java code shown as follows：

    ![](assets/Talend/markdown-img-paste-20180910202047622.png)
  ...
  - The configuration of **tFileInputDelimited** shown as following pic:
    ...
    ![](assets/Talend/markdown-img-paste-20181027161437375.png)
  ...
  ![](assets/Talend/markdown-img-paste-20181027161745118.png)
  ...
  ![](assets/Talend/markdown-img-paste-20181027162050223.png)
  ...
  ![](assets/Talend/markdown-img-paste-20181027162342379.png)
  ...
  ![](assets/Talend/markdown-img-paste-20181027163025959.png)
  ...
  ![](assets/Talend/markdown-img-paste-20180910204755477.png)
