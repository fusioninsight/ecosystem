...
* 修改 Hadoop File Input配置
  ...
  ![](assets/Kettle_6.1/image42.png)

  点击 **字段** 页签，获取字段

  ![](assets/Kettle_6.1/image43.png)
...
* 修改Microsoft Excel输出配置
  ...
  ![](assets/Kettle_6.1/image46.png)

  点击 **内容** 页签，获取字段

  ![](assets/Kettle_6.1/image47.png)
